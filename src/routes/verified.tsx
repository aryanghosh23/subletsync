  ...
  head: () => ({
    meta: [
      { title: "Verified Listings — SubletSync" },
      {
        name: "description",
        content:
          "Every SubletSync listing is backed by .edu verification, student ID, and lease documents. Trust, by default.",
      },
    ],
  }),
});
...
const STEPS = [
  ...
  { n: "03", t: "Add lease documents", d: "Required for every listing. Stored securely." },
  {
    n: "04",
    t: "Listing goes live",
    d: "Verified student + Verified lease badges shown publicly.",
  },
];
...
const AMENITIES = [
  ...
  {
    icon: "M5 12h14M5 12a2 2 0 110-4h14a2 2 0 110 4M5 12v7a2 2 0 002 2h10a2 2 0 002-2v-7M9 16h6",
...
const REVIEWS = [
  {
    by: "Jordan M.",
    role: "Previous sublessee · Fall 2024",
    stars: 5,
    text: "Aisha was organized and responsive. Unit was exactly as pictured, 5-minute walk to ECSW. Lease handoff took one afternoon.",
  },
  {
    by: "Priya S.",
    role: "Neighbor · Verified resident",
    stars: 5,
    text: "Quiet floor, secure entry, and the parking is legit covered. Would recommend anyone from the CS cohort.",
  },
];
    ...
    <div className="min-h-screen flex flex-col">
      ...
      <section className="mx-auto max-w-6xl px-6 pt-16 pb-16">
        ...
        <p className="mt-6 text-lg text-muted-foreground max-w-xl">
          On Facebook Marketplace, you're trusting a stranger. On SubletSync, every poster has a
          verified .edu email, a student ID on file, and a real lease document tied to the unit.
        </p>
      </section>
          ...
          <div className="grid md:grid-cols-[1fr_320px] gap-10">
            <div>
              ...
              <p className="text-muted-foreground mt-2">
                Northside Residences · 0.3 mi from UT Dallas
              </p>
              ...
              <div className="mt-10">
                ...
                <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
                  {AMENITIES.map((a) => (
                    <div
                      key={a.label}
                      className="rounded-xl border border-border bg-background px-3 py-3 flex items-center gap-2"
                    >
                      <svg
              ...
              <div className="mt-10">
                ...
                <ul className="space-y-2.5">
                  {[
                    ...
                    <li
                      key={p}
                      className="flex items-center justify-between rounded-lg bg-cream/50 px-4 py-2.5"
                    >
                ...
                <div className="flex items-center gap-4">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-sm text-muted-foreground">
                      UT Dallas · Junior · aisha.k@utdallas.edu ✓
                    </p>
                  </div>
