...
export function ListingCard({ image, title, location, price, dates, badges = [], matchScore }: Props) {
  return (
    <article className="group rounded-2xl bg-card overflow-hidden border border-border/60 hover:shadow-[var(--shadow-lift)] transition-all duration-300">
      ...
      <div className="p-5">
        <div className="flex items-start justify-between gap-3 mb-1">
          ...
          <span className="font-display text-lg font-semibold text-primary whitespace-nowrap">{price}</span>
        </div>
